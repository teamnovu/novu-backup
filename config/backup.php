...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('APP_NAME', 'unnamed-backup'),
        ...
        'source' => [
            ...
            'files' => [
                 ...
                 */
                'include' => explode(',', env('BACKUP_FOLDERS')),
                 ...
                 */
                'exclude' => explode(',', env('BACKUP_IGNORE_FOLDERS')),
             ...
             */
            'databases' => explode(',', env('BACKUP_DB_CONNECTIONS')),
        ],
    ...
    'notifications' => [
        ...
        'slack' => [
            'webhook_url' => 'https://hooks.slack.com/services/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',
